...
function CareerPathSelector({
  ...
  const handleSelectionChange = (event) => {
    ...
    const fullSelectedPath = pathsData.paths.find(
      (p) => p.Path_name === selectedValue
    );
          ...
          >
            ...
            >
              ...
              <div className="text-sm space-y-1 text-gray-600 dark:text-gray-400">
                <p>
                  <strong className="font-semibold text-gray-700 dark:text-gray-300 mr-1">
                    Stages:
                  </strong>
                ...
                <p>
                  ...
                  {Array.isArray(path.Required_skills)
  ...
  pathsData: PropTypes.shape({
    paths: PropTypes.arrayOf(
      PropTypes.shape({
        ...
        Stages: PropTypes.oneOfType([
          PropTypes.string,
          PropTypes.arrayOf(PropTypes.string),
        ]),
        Timeline: PropTypes.string,
        Salary_range: PropTypes.string,
        Industries: PropTypes.oneOfType([
          PropTypes.string,
          PropTypes.arrayOf(PropTypes.string),
        ]),
        Risk_level: PropTypes.string,
        AI_impact: PropTypes.string,
        Required_skills: PropTypes.oneOfType([
          PropTypes.string,
          PropTypes.arrayOf(PropTypes.string),
        ]),
        Accelerators: PropTypes.oneOfType([
          PropTypes.string,
          PropTypes.arrayOf(PropTypes.string),
        ]),
