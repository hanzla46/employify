    ...
    <div className="min-h-screen pt-16 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold mb-8 dark:text-white">Skills Roadmap</h1>
              ...
              <div key={index} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="ml-4">
                      <h2 className="text-xl font-semibold dark:text-white">{path.title}</h2>
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">Skills Covered</h3>
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">Level</h3>
