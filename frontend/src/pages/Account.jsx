...
import { User, LogOut, Settings, CreditCard, Shield, History, Moon, Sun } from "lucide-react";
            ...
            <div className="lg:col-span-9">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                ...
                <div className="space-y-4">
                  {[
                    { action: "Password Changed", date: "March 10, 2025", icon: Shield },
                    { action: "Logged in from new device", date: "March 8, 2025", icon: User },
                    { action: "Subscription renewed", date: "March 1, 2025", icon: CreditCard }
                  ].map((item, index) => (
