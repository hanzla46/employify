...
export function Roadmap() {
  ...
  const { hasProfile, setHasProfile, evaluated, setEvaluated } = useContext(SkillsContext);
    ...
    <div className='min-h-screen pt-10 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-700'>
      <div className='container mx-auto px-2 py-4'>
        <div className='max-w-full mx-auto'>
          <h1 className='fixed left-0 top-12 text-2xl font-bold mb-4 dark:text-white'>Personalized Roadmap</h1>
