...
import { Brain, BookOpen, Briefcase, MessageSquare, Target, ArrowRight, Moon, Sun, ChevronRight } from 'lucide-react';
...
export function Home() {
  ...
  return (
    <div className="min-h-screen pt-16 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <header className="py-20 lg:py-28 relative">
          ...
          <div className="max-w-6xl mx-auto relative">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="absolute top-10 right-10 bg-white/90 dark:bg-gray-800/90 p-4 rounded-xl shadow-lg backdrop-blur-sm border border-gray-200 dark:border-gray-700 max-w-xs hidden lg:block" data-aos="fade-left" data-aos-delay="400">
              ...
              <div className="absolute bottom-10 left-10 bg-white/90 dark:bg-gray-800/90 p-4 rounded-xl shadow-lg backdrop-blur-sm border border-gray-200 dark:border-gray-700 hidden lg:block" data-aos="fade-right" data-aos-delay="600">
                <div className="flex items-center">
                  <div className="mr-4">
        ...
        <section className="py-24 relative" data-aos="fade-up">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <span className="inline-block py-1 px-3 rounded-full bg-indigo-100 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 text-sm font-medium mb-4">FEATURES</span>
              <h2 className="text-4xl font-bold mb-6 dark:text-white">Transform Your Career Journey</h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">Powerful tools designed to help you succeed in today's competitive job market</p>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Link to="/interview" className="transition-all duration-300 hover:scale-105">
                <FeatureCard
                  icon={MessageSquare}
              ...
              <Link to="/jobs" className="transition-all duration-300 hover:scale-105">
                <FeatureCard
                  icon={Briefcase}
        ...
        <section className="py-24 bg-gray-50 dark:bg-gray-800/20 rounded-3xl my-10" data-aos="fade-up">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-16">
              <span className="inline-block py-1 px-3 rounded-full bg-purple-100 dark:bg-purple-900/40 text-purple-600 dark:text-purple-400 text-sm font-medium mb-4">TESTIMONIALS</span>
              <h2 className="text-4xl font-bold mb-6 dark:text-white">Success Stories</h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">See how our platform has helped professionals advance their careers</p>
            </div>
        ...
        <section className="py-24 relative overflow-hidden" data-aos="fade-up">
          ...
          <div className="max-w-6xl mx-auto px-4 relative">
            <div className="text-center mb-16">
              <span className="inline-block py-1 px-3 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 text-sm font-medium mb-4">IMPACT</span>
              <h2 className="text-4xl font-bold mb-6 dark:text-white">Our Results Speak Volumes</h2>
            </div>
        ...
        <section className="py-24" data-aos="fade-up">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-16">
              <span className="inline-block py-1 px-3 rounded-full bg-green-100 dark:bg-green-900/40 text-green-600 dark:text-green-400 text-sm font-medium mb-4">PRICING</span>
              <h2 className="text-4xl font-bold mb-6 dark:text-white">Simple, Transparent Pricing</h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">Choose the plan that works best for your career goals</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-gray-800/40 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 flex flex-col">
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Perfect for exploring our platform</p>
                </div>
                <div className="mb-6">
                ...
                <Link to="/signup" className="bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-white px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-all text-center">
                  Start Free
                </Link>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800/40 p-8 rounded-2xl shadow-xl border-2 border-indigo-500 dark:border-indigo-400 flex flex-col relative">
                ...
                <div className="mb-6">
                  <span className="text-4xl font-bold text-indigo-600 dark:text-indigo-400">$29</span>
                  <span className="text-gray-500 dark:text-gray-400">/month</span>
                </div>
                <ul className="space-y-3 mb-8 flex-grow">
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                ...
                <Link to="/pricing" className="bg-indigo-600 dark:bg-indigo-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-all shadow-lg hover:shadow-indigo-500/25 text-center">
                  Get Pro
                </Link>
              </div>
        ...
        <section className="py-24 my-10 rounded-3xl relative overflow-hidden" data-aos="fade-up">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center relative">
            ...
            <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">Join thousands of professionals who have transformed their careers with our AI-powered platform</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/signup"
