          ...
          <div className='max-w-6xl mx-auto relative'>
            <div className='text-center mb-16' data-aos='fade-up'>
              ...
              <p className='text-xl md:text-xl text-gray-800 dark:text-gray-300 mb-10 max-w-3xl mx-auto font-light'>
                Master interviews, discover perfect job matches, and accelerate your career growth with personalized AI
                guidance
              </p>
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
                Powerful tools designed to help you succeed in today's competitive job market
              </p>
            </div>
        ...
        <section className='py-24' data-aos='fade-up'>
          <div className='max-w-5xl mx-auto'>
            <div className='text-center mb-16'>
              ...
              <h2 className='text-4xl font-bold mb-6 dark:text-white'>Your Path to Career Success in 3 Steps</h2>
              <p className='text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto'>
                Simple steps to leverage AI for your job search and skill development.
              </p>
            </div>
              ...
              <div className='hidden md:block absolute top-8 left-0 right-0 h-1 w-full'>
                <svg width='100%' height='100%'>
                  <line
                    ...
                    strokeWidth='2'
                  />
                  <circle cx='16.66%' cy='50%' r='4' className='fill-current text-indigo-500 dark:text-indigo-400' />
                  <circle cx='50%' cy='50%' r='4' className='fill-current text-indigo-500 dark:text-indigo-400' />
                  <circle cx='83.33%' cy='50%' r='4' className='fill-current text-indigo-500 dark:text-indigo-400' />
                </svg>
              </div>
        ...
        <section className='py-24 bg-gray-50 dark:bg-gray-800/20 rounded-3xl my-10' data-aos='fade-up'>
          <div className='max-w-6xl mx-auto px-4'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
                See how our platform has helped professionals advance their careers
              </p>
            </div>
              ...
              <div className='bg-white dark:bg-gray-800/40 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 flex flex-col'>
                ...
                <ul className='space-y-3 mb-8 flex-grow'>
                  <li className='flex items-center text-gray-600 dark:text-gray-300'>
                    <ChevronRight className='h-5 w-5 text-green-500 mr-2' />3 AI Interview Sessions
                  </li>
                  <li className='flex items-center text-gray-600 dark:text-gray-300'>
                  ...
                  <li className='flex items-center text-gray-600 dark:text-gray-300'>
                    <ChevronRight className='h-5 w-5 text-green-500 mr-2' />1 Skill Assessment
                  </li>
                </ul>
                <Link
                  to='/signup'
