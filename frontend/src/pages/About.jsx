  ...
  const values = [
    {
      ...
      title: "User-Centric",
      description:
        "We put our users first in everything we do, ensuring the best possible experience.",
    },
    {
      icon: Target,
      title: "Innovation",
    ...
    },
    {
      ...
      title: "Excellence",
      description:
        "Committed to delivering the highest quality career development tools.",
    },
  ];
  ...
  const milestones = [
    {
      ...
      title: "Founded",
      description:
        "Employify was established with a vision to transform career development.",
    },
    {
      year: "2024",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      >
        ...
        <div className="container relative mx-auto px-4 py-12 text-center">
          ...
          >
            We're on a mission to revolutionize career development through
            artificial intelligence, making professional growth accessible and
                ...
                <div className="md:col-span-3 order-2 md:order-1">
                  ...
                  <div className="space-y-4">
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Founded in 2024, Employify emerged from a simple
                      observation: traditional career development methods
                      weren't keeping pace with rapidly evolving industries and
                      job markets.
                    </p>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      We combined advanced AI technology with expert career
                      guidance to create a platform that adapts to each
                      individual's unique career journey, providing personalized
                      support at every step.
                    </p>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Our AI-driven tools analyze job market trends, individual
                      skills, and career aspirations to provide actionable
                      insights that help users make informed decisions about
                      their professional development.
                    </p>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Today, Employify is helping thousands of professionals
                      worldwide navigate their career paths with confidence,
                      powered by our founding team of Hanzla, Hina, and Izhar!
                    </p>
                  </div>
                  ...
                  <div className="mt-8">
                    ...
                    >
                      Learn how we can help your career{" "}
          ...
          <div className="relative mb-16 overflow-hidden">
            ...
            <div className="relative p-10 text-center text-white">
              ...
              <p className="text-indigo-100 max-w-2xl mx-auto mb-8 text-lg">
                ...
                passion for revolutionizing career development. Join us in
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Have questions about our platform or interested in a
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
                <h3 className="text-lg font-semibold mb-3 dark:text-white">
                  How does Employify work?
                </h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Employify uses advanced AI to analyze your skills, experience,
                  and career goals, then provides personalized recommendations
                  for career development paths and opportunities.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
                <h3 className="text-lg font-semibold mb-3 dark:text-white">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  We take data security seriously. All user data is encrypted
                  and never shared with third parties without explicit
                  permission.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Yes, we offer tailored solutions for organizations looking to
                  enhance their talent development programs.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
                <h3 className="text-lg font-semibold mb-3 dark:text-white">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Our job market data and industry trends are updated weekly to
                  ensure you receive the most current information for your
                  career planning.
                </p>
              </div>
            </div>
