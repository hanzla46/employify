...
import { Users, Target, Shield, Award, ChevronRight, MapPin, Calendar, Mail, ArrowRight, Github, Linkedin, Twitter } from 'lucide-react';
...
export function About() {
  ...
  const milestones = [
    { year: '2024', title: 'Founded', description: 'Employify was established with a vision to transform career development.' },
    { year: '2024', title: 'First 1,000 Users', description: 'Reached our first milestone of 1,000 active users.' },
    { year: '2024', title: 'AI Engine v1', description: 'Launched our proprietary career matching algorithm.' },
    { year: '2025', title: 'Global Expansion', description: 'Expanded our services to 30+ countries worldwide.' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      >
        ...
        <div className="container relative mx-auto px-4 py-12 text-center">
          ...
          >
            <a href="#team" className="bg-white dark:bg-gray-800 text-indigo-600 dark:text-indigo-400 px-6 py-3 rounded-full font-medium shadow-md hover:shadow-lg transition-all flex items-center gap-2">
              Meet our team <ChevronRight size={16} />
            </a>
            <a href="#contact" className="bg-indigo-600 dark:bg-indigo-500 text-white px-6 py-3 rounded-full font-medium shadow-md hover:shadow-lg transition-all">
              Get in touch
            </a>
          </motion.div>
          ...
          <div className="flex overflow-x-auto mb-8 pb-2 scrollbar-hide">
            <div className="flex gap-2 mx-auto border border-gray-200 dark:border-gray-700 rounded-full p-1 bg-white dark:bg-gray-800 shadow-sm">
              <button 
                ...
                className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'story' ? 'bg-indigo-600 text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
              >
                Our Story
              </button>
              <button 
                onClick={() => setActiveTab('values')}
                className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'values' ? 'bg-indigo-600 text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
              >
                Our Values
              </button>
              <button 
                onClick={() => setActiveTab('team')}
                className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'team' ? 'bg-indigo-600 text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
              >
                Our Team
              </button>
              <button 
                onClick={() => setActiveTab('journey')}
                className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'journey' ? 'bg-indigo-600 text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
              >
                Our Journey
              </button>
            </div>
              ...
              >
                <div className="md:col-span-3 order-2 md:order-1">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Our AI-driven tools analyze job market trends, individual skills, and career aspirations
                      to provide actionable insights that help users make informed decisions about their
                      professional development.
                    </p>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Today, Employify is helping thousands of professionals worldwide navigate their career
                      paths with confidence, powered by our founding team of Hanzla, Hina, and Izhar!
                    </p>
                  </div>
                  
                  <div className="mt-8">
                    <a href="#contact" className="inline-flex items-center text-indigo-600 dark:text-indigo-400 font-medium hover:underline">
          ...
          <div className="relative mb-16 overflow-hidden">
            ...
            <div className="relative p-10 text-center text-white">
              ...
              <p className="text-indigo-100 max-w-2xl mx-auto mb-8 text-lg">
                ...
                revolutionizing career development. Join us in building the future of work.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">123 Innovation Drive, Tech Park, CA 94103</p>
                    </div>
                  </div>
                  <div className="flex items-start">
              ...
              <div>
                <form className="space-y-4">
                  ...
                  <button type="submit" className="w-full bg-indigo-600 dark:bg-indigo-500 text-white px-6 py-3 rounded-lg font-medium hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors">
                    Send Message
                  </button>
                </form>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Employify uses advanced AI to analyze your skills, experience, and career goals, then provides personalized recommendations for career development paths and opportunities.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
                <h3 className="text-lg font-semibold mb-3 dark:text-white">Is my data secure?</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  We take data security seriously. All user data is encrypted and never shared with third parties without explicit permission.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Our job market data and industry trends are updated weekly to ensure you receive the most current information for your career planning.
                </p>
              </div>
            </div>
          </div>
